...
import com.orengesunshine.todowithapi.component.ActivityComponent;
import com.orengesunshine.todowithapi.component.DaggerActivityComponent;
...
public class CreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityComponent component = DaggerActivityComponent.builder()
                .appComponent(ToDoApp.getTodoApp(this).component)
                .build();
        component.injectCreateActivity(this);
        //get api key from sharedPreferences
        SharedPreferences pref = getSharedPreferences(LoginActivity.USER_PREF, Context.MODE_PRIVATE);
